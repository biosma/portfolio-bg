...
export function TradenethubSection({ miniature = false }) {
  const t = useTranslations('WorkPage.TradenetHub');
  ...
  const project = {
    ...
    images: [
      '/tradenethub/dashboard_view.png',
      '/tradenethub/calendar_view.png',
      '/tradenethub/cargo_view.png',
      '/tradenethub/cashflow_view.png',
      '/tradenethub/contract_view.png',
      '/tradenethub/dashboard_view2.png',
      '/tradenethub/login_view.png',
      '/tradenethub/operativeflow_view.png',
    ],
    demoUrl: '#',
    codeUrl: '#',
    technologies: {
      ...
      integrations: ['DocuSign API', 'SeaRates API', 'Exchange Rate API'],
      tools: ['i18n', 'Recharts', 'Zustand', 'React Hook Form', 'Zod'],
    },
  };
