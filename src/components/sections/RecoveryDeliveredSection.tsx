...
export function RecoveryDeliveredSection({ miniature = false }) {
  const t = useTranslations('WorkPage.RecoveryDelivered');
  ...
  const project = {
    ...
    images: ['/recovery_delivered/features_rd.png'],
    demoUrl: '#',
    codeUrl: '#',
    technologies: {
      frontend: ['React web', 'React native - mobile', 'Next web', 'Bootstrap web'],
      backend: ['Node.js', 'MongoDB', 'DynamoDB', 'FHIR'],
      integrations: ['Stripe', 'PubNub', 'NewCrop', 'Vonage (Videocall, SMS notifications)'],
      aws: ['AWS SES', 'AWS EC2', 'AWS Cognito', 'AWS S3', 'AWS (Other services)'],
      tools: ['Redux Toolkit', 'Yup', 'Formik', 'ESLint/Prettier', 'Moment.js', 'i18next'],
    },
  };
