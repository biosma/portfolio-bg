...
export function MentisSection({ miniature = false }) {
  const t = useTranslations('WorkPage.Mentis');
  ...
  const project = {
    ...
    images: [
      ...
      '/mentis/Calendar.png',
      '/mentis/Patients.png',
      '/mentis/Patient_Creation.png',
      '/mentis/Appointment.png',
      '/mentis/Messages_List.png',
    ],
    demoUrl: '#',
    codeUrl: '#',
    technologies: {
      frontend: [
        ...
        'TypeScript',
        'Tailwind CSS',
        'Chart.js', // Para analíticas médicas
      ...
      integrations: [
        ...
        'FHIR', // Interoperabilidad de salud
        'HL7', // Estándar de mensajería médica
        'Vonage Video', // Videollamadas médicas
        'Stripe', // Pagos online (si aplica, para SaaS médicos)
        'NewCrop', // Prescripción digital
        'Google Maps', // Geolocalización para clínicas/pacientes
      ],
      tools: [
        'Zustand', // Control de estado global
